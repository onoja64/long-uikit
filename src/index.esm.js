...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f1f0f0", backgroundDisabled: "#E9EAEB", contrast: "#0b2b27", invertedContrast: "#FFFFFF", input: "#ebf4ea", tertiary: "#EFF4F5", text: "#1a1873", textDisabled: "#BDC2C4", textSubtle: "#1e5951", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#101961", background: "#343135", backgroundDisabled: "#2832a3", contrast: "#FFFFFF", invertedContrast: "#0d4039", input: "#D1A5041", primaryDark: "#D1A5041", tertiary: "#2832a3", text: "#FFFFFF", textDisabled: "#cccccc", textSubtle: "#c9c4d4", borderColor: "#2832a3", card: "#27262c", gradients: {
        bubblegum: "linear-gradient(139.73deg, #101961 0%, #1a1873 100%)",
    } });
